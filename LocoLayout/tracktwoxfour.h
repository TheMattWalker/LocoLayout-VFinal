...
**
****************************************************************************/
#ifndef TRACKTWOXTHREE_H
#define TRACKTWOXTHREE_H

#include <QColor>
#include <QGraphicsObject>

class TrackTwoXFour : public QGraphicsObject
{
Q_OBJECT
public:
    TrackTwoXFour(int toolSelected, int x, int y);
