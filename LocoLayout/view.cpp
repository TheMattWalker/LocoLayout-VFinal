...
//Reimplementation of QGraphicsView. Holds the QGraphicsScene. This is the frame that displays the grid
...
void View::toggleAntialiasing(bool ok)
{
    graphicsView->setRenderHint(QPainter::Antialiasing, ok);
}
...
QTransform View::getQTransform()
{
    return view()->transform();
}

void View::setLayoutName(QString string)
{
    layoutName->setText(string);
}
