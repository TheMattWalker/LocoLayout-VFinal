...
**
****************************************************************************/
#ifndef TRACKTHREEXTWO_H
#define TRACKTHREEXTWO_H

#include <QColor>
#include <QGraphicsObject>

class TrackFourXTwo : public QGraphicsObject
{
Q_OBJECT
public:
    TrackFourXTwo(int toolSelected, int x, int y);
